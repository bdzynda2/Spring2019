...
Losing trader behavior is more sensitivite to the level of their losses than winning traders to the level of their gains!
...
- Traders with losses in the morning are much more dramatically recersed than those set by traders with gains in the morning. 
...
- Loss aversion may lead to greater afternoon risk seeking and increaed placement of price-moving trades 
...
$$\sigma_{h,t}^A = \alpha + \beta_{\sigma} \sigma_{h,t}^M + \beta_\lambda ^M + \varepsilon _t$$

- $\sigma^A$ measures abnormal volatilityof afternoon price changes for frequency $h$. 
