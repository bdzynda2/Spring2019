...
- Significant Returns in MAX Portfolio still remain
...
- MAX returns not explained by other potential sources of momentum


## Extension

(1) What explains positive abnormal returns of MAX portfolio? Why is MIN explained? Ommitted Risk Factor?
