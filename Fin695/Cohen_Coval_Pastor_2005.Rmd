...
- Persistence in performance weakins when momentum benchmark is included
- Most predictive power acheived with $\hat \delta^*$
...
- Look cheifly at average of portfolios that buy funds with high $\hat \delta^*$ and shorts low $\hat \delta^*$ within a given $\hat \alpha$ quintile
